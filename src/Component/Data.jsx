            ...
            <div className='rounded-[10px] w-[100%] border overflow-y-auto'>
                <div className="w-full h-auto flex flex-col lg:flex-row items-center justify-between px-4 lg:px-6 py-4 border-b bg-[#181819] text-white space-y-4 lg:space-y-0">
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-end space-x-2 lg:space-x-4">
                        <select value={sortOrder} onChange={(e) => setSortOrder(e.target.value)} className="p-2 border rounded-md bg-gray-200 text-black hover:bg-gray-300 transition w-40 sm:w-48">
                            <option value="">Sort by Price</option>
                            <option value="asc">Low to High</option>
                            <option value="desc">High to Low</option>
                        </select>

                        <select value={filterPrice} onChange={(e) => setFilterPrice(e.target.value)} className="p-2 border rounded-md bg-gray-200 text-black hover:bg-gray-300 transition w-40 sm:w-48">
                        ...
                        <input type="text" value={searchTitle} onChange={(e) => setSearchTitle(e.target.value)} placeholder="Search by title" className="p-2 border rounded-md bg-gray-200 text-black hover:bg-gray-300 transition w-40 sm:w-48" />
                        <button onClick={() => navigat("/productform")} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition w-40 sm:w-auto">
                            Add Product
                        </button>
                    </div>
                </div>
