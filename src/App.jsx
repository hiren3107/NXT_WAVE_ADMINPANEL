  ...
  return (
    <>
      <div className=" mmm w-[100%]  h-auto flex relative ">
        <div id="sidebars" className={`bg-[#181819] h-[100%] z-[40] lg:h-[100vh] sm:w-[100%] absolute lg:static transition-all duration-500 ease-in-out ${isOpen ? 'lg:w-[15%] w-[60%] sm:right-[100%] lg:right-[0]' : 'lg:w-[4%] xl:ps-[2%] xl:w-[6%] w-0  ms-[-50px] sm:w-[350px]'}`}>
          {isOpen ? <div id="toggle_div" className={`  ${isOpen ? "block" : "hidden"}     `}     >
            ...
            {isOpen && (
              <button id="bt" className="lg:absolute top-[0] sm:hidden absolute left-[80%] lg:left-[10%]" onClick={toggleSidebar}>❌</button>
            )}

            {!isOpen && (
              <button
                id="bt" className="sm:absolute lg:left-[-95%] absolute lg:hidden top-[0] right-[0]" onClick={toggleSidebar}>
                ❌
              </button>
            )}
            <Link to={'/'}>
            ...
            <button id="bt" className="sm:absolute lg:left-[-95%] absolute lg:hidden top-[0] right-[0]" onClick={toggleSidebar}>❌</button>
            <Link to={'/'}>
              <div id="Logo" className="w-[100%] h-[80px] flex justify-center items-center">
                <img src={h} alt="" />
              </div>
        ...
        <div
          id="div" className={`bg-[#28282A] h-[100vh] overflow-auto scroll-smooth transition-all duration-500 ease-in-out ${isOpen ? 'lg:w-[100%] w-[100%]' : 'w-[100%]'}`}>
            ...
            <div className='w-[100%] h-[75px] lg:ps-[20px] pe-[1px] lg:pe-[20px] flex justify-between items-center '>
              ...
              <div className='flex w-[85%] sm:w-[50%] h-[70%] lg:w-[60%] h-[70%] lg:justify-end  items-center justify-evenly '>
                <div className='w-[70%] sm:w-[40%] h-[100%] ms-[-10px] lg:ms-[1px]   flex items-center justify-evenly'>
                  <div id='inputDiv' className='z-[0]'>
                    <i class="fa-solid fa-magnifying-glass text-[15px]" id='searchicon'></i>
                    <input className='w-[70%] h-[30px]  sm:w-[90%] sm:ms-[5px]  lg:h-[35px] lg:w-[300px] text-[1.3vw]' id='appinput' type="text" placeholder='Search' />
                  </div>
                </div>
